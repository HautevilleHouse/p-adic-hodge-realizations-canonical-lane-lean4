/-!
# p-adic-hodge-realizations-canonical-lane Lean migration boundary
...
`PAdicHodgeRealizationsCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "p-adic-hodge-realizations-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/p-adic-hodge-realizations-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for p-adic Hodge Realizations: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["manifold-constrained", "canonical-lane", "local-to-global", "p-adic-hodge-theory", "period-rings", "galois-representations", "arithmetic-geometry", "mathematical-proof", "reproducibility"]
